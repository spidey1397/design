...
<body>
			...
			<div class="row">
				<div class="col-lg-5">
					<div class="service-slider">
						<div class="ss-single">
							<img src="{{ asset('assets')}}/img/service/1.jpg" alt="">
						</div>
						<div class="ss-single">
							<img src="{{ asset('assets')}}/img/service/2.jpg" alt="">
						</div>
						<div class="ss-single">
							<img src="{{ asset('assets')}}/img/service/3.jpg" alt="">
						</div>
					</div>
				</div>
	...
	<div class="service-box-section spad set-bg" data-setbg="{{ asset('assets')}}/img/service-bg.jpg">
		<div class="container">
			<div class="row">
			...
			<div class="row">
					...
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/1.png" alt="">
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/2.png" alt="">
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/3.png" alt="">
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/4.png" alt="">
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/5.png" alt="">
							</div>
						</div>
						<h3>Documentation</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sed dui eget lorem tincidunt.</p>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{ asset('assets')}}/img/icon/dark/6.png" alt="">
							</div>
						</div>
	...
	<section class="promo-section pt-0">
		<div class="promo-box set-bg" data-setbg="{{ asset('assets')}}/img/bg.jpg">
			<div class="container">
				<div class="row">
