...
<body>
	...
	@include('template.home.content.header.blade.php')
	<!-- Page header section start -->
	<section class="page-header-section set-bg" data-setbg="{{ asset('assets')}}/img/header-bg-1.jpg">
		<div class="container">
				...
				<div class="col-lg-3 col-md-5 mt-5 mt-lg-0 sidebar">
					...
					<div class="widget-area">
						...
						<div class="rp-widget">
							<div class="rp-widget-item">
								<div class="thumb">
									<img src="{{ asset('assets')}}/img/blog/recent-post/1.jpg" alt="#">
								</div>
							...
							<div class="rp-widget-item">
								<div class="thumb">
									<img src="{{ asset('assets')}}/img/blog/recent-post/2.jpg" alt="#">
								</div>
								<div class="rp-content">
							...
							<div class="rp-widget-item">
								<div class="thumb">
									<img src="{{ asset('assets')}}/img/blog/recent-post/3.jpg" alt="#">
								</div>
								<div class="rp-content">
							...
							<div class="rp-widget-item">
								<div class="thumb">
									<img src="{{ asset('assets')}}/img/blog/recent-post/4.jpg" alt="#">
								</div>
								<div class="rp-content">
					...
					<div class="widget-area">
						...
						<div class="instagram-widget">
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/1.jpg" alt="#"></a>
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/2.jpg" alt="#"></a>
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/3.jpg" alt="#"></a>
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/4.jpg" alt="#"></a>
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/5.jpg" alt="#"></a>
							<a href="#"><img src="{{ asset('assets')}}/img/blog/instagram/1.jpg" alt="#"></a>
						</div>
					</div>
				</div>
